...
| `stopId`               | The id of faulty stop.                              | String |
| `missingArrivalTime`   | The stop is missing arrival time.                   | String |
| `missingDepartureTime` | The stop is missing departure time.                 | String |
